...
<div className="w-[1px]  text-[2px] text-white">{"1"}</div>
    ...
    >
      ...
      <div class="mx-6 py-10 text-center md:text-left text-white font-semibold items-center">
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-2 items-center">
          <div>
            ...
            <Link
              class="mb-4 flex items-center justify-center font-semibold  md:justify-center"
           href={"/"}
            >
      ...
      {<div class="bg-neutral-200 p-6 text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 text-white" style={{backgroundColor:"black"}}>
        <span>© 2024</span>
