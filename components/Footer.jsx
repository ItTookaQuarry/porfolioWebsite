    ...
    >
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500  text-white">
        ...
        <div className="flex justify-center">
          ...
          <Link href="https://www.instagram.com/przemyslawkoniecznyy/?igsh=cWI4Z3V1eDB1dXVv&utm_source=qr" className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
          ...
          <Link href="https://www.linkedin.com/in/przemys%C5%82aw-konieczny-2979a4266/" className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="text-white h-4 w-4"
              fill="currentColor"
          ...
          <Link href="https://github.com/ItTookaQuarry" className="text-neutral-600 dark:text-neutral-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="text-white h-4 w-4"
              fill="currentColor"
      ...
      <div className="mx-6 py-10 text-center md:text-left text-white font-semibold items-center">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-2 items-center">
          <div>
            ...
            <Link
              className="mb-4 flex items-center justify-center font-semibold  md:justify-center"
           href={"/projects"}
            >
      ...
      {<div className="bg-neutral-200 p-6 text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 text-white" style={{backgroundColor:"black"}}>
        <span>© 2024</span>
